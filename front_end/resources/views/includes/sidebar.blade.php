<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    ...
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{'/pages/color'}}">
                <svg class="c-sidebar-nav-icon">
                    <use xlink:href="{{asset('vendors/@coreui/icons/svg/free.svg#cil-drop1')}}"></use>
                </svg> Colors</a></li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{'/pages/typography'}}">
                <svg class="c-sidebar-nav-icon">
...
{{--                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="base/tooltips.html"><span class="c-sidebar-nav-icon"></span> Tooltips</a></li>--}}
        ...
        <li class="c-sidebar-nav-item c-sidebar-nav-dropdown"><a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{'/pages/buttons/button/'}}"><span class="c-sidebar-nav-icon"></span> Buttons</a></li>
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{'/pages/buttons/brand-groups'}}"><span class="c-sidebar-nav-icon"></span> Brand Buttons</a></li>

                {{--                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{'pages/buttons/button-group'}}"><span class="c-sidebar-nav-icon"></span> Buttons Group</a></li>--}}
{{--                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="buttons/dropdowns.html"><span class="c-sidebar-nav-icon"></span> Dropdowns</a></li>--}}
        ...
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{'/pages/charts'}}">
                <svg class="c-sidebar-nav-icon">
...
{{--                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="notifications/modals.html"><span class="c-sidebar-nav-icon"></span> Modals</a></li>--}}
        ...
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{'/pages/widgets'}}">
                <svg class="c-sidebar-nav-icon">
...
{{--                        </svg> Error 500</a></li>--}}
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link c-sidebar-nav-link-danger" href="{{ route('logout') }}"
                ...
                <svg class="c-sidebar-nav-icon">
                    <use xlink:href="{{asset('vendors/@coreui/icons/svg/free.svg#cil-exit')}}"></use>
                </svg>
                    LOGOUT
