                    ...
                    <div class="card-body">
                        ...
                        <p>
                            ...
                            <button class="btn btn-sm btn-flickr" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-flickr"></use>
                                </svg><span>Flickr</span>
                            </button>
                            <button class="btn btn-sm btn-tumblr" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-tumblr"></use>
                                </svg><span>Tumblr</span>
                            </button>
                            <button class="btn btn-sm btn-xing" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-xing"></use>
                                </svg><span>Xing</span>
                            </button>
                            <button class="btn btn-sm btn-github" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-github"></use>
                                </svg><span>Github</span>
                            </button>
                            <button class="btn btn-sm btn-stack-overflow" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-stack-overflow"></use>
                                </svg><span>StackOverflow</span>
                            </button>
                            <button class="btn btn-sm btn-youtube" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-youtube"></use>
                                </svg><span>YouTube</span>
                            </button>
                            <button class="btn btn-sm btn-dribbble" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-dribbble"></use>
                                </svg><span>Dribbble</span>
                            </button>
                            <button class="btn btn-sm btn-instagram" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-instagram"></use>
                                </svg><span>Instagram</span>
                            </button>
                            <button class="btn btn-sm btn-pinterest" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-pinterest"></use>
                                </svg><span>Pinterest</span>
                            </button>
                            <button class="btn btn-sm btn-vk" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-vk"></use>
                                </svg><span>VK</span>
                            </button>
                            <button class="btn btn-sm btn-yahoo" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-yahoo"></use>
                                </svg><span>Yahoo</span>
                            </button>
                            <button class="btn btn-sm btn-behance" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-behance"></use>
                                </svg><span>Behance</span>
                            </button>
                            <button class="btn btn-sm btn-reddit" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-reddit"></use>
                                </svg><span>Reddit</span>
                            </button>
                            <button class="btn btn-sm btn-vimeo" type="button">
                                <svg class="c-icon mr-2">
                                    <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-vimeo"></use>
                                </svg><span>Vimeo</span>
                            </button>
                        </p>
                        <h6>Size Normal</h6>
